...
var (
	...
	QuickFixEnabled = false // 忽略一些会导致崩溃的bug，显示警告信息。以后再修复bug。
...
func InspectComponentParameters(tid string, params []interface{}) {
	fmt.Println("\n--------------------------------------------------------------------------------")
	fmt.Println("Parameters in component with tid: ", tid)
